...
# Filter out random types, so it'll reset to MARKOX89
...
ifdef CM_BUILDTYPE
    ...
    # If CM_BUILDTYPE is not defined, set to MARKOX89
    CM_BUILDTYPE := MARKOX89
    CM_EXTRAVERSION :=
endif

ifeq ($(CM_BUILDTYPE), MARKOX89)
    ifneq ($(TARGET_MARKOX89_BUILD_ID),)
        CM_EXTRAVERSION := -$(TARGET_MARKOX89_BUILD_ID)
    endif
endif
